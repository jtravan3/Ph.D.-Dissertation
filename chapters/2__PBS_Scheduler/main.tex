...
\input{chapters/2__PBS_Scheduler/sections/introduction}
\input{chapters/2__PBS_Scheduler/sections/problem_definition}
\input{chapters/2__PBS_Scheduler/sections/related_work}

%%%%%% BEGINNING OF SYSTEM MODEL SECTION %%%%%%%
\input{chapters/2__PBS_Scheduler/sections/system_model/definitions}
\input{chapters/2__PBS_Scheduler/sections/system_model/environment}
...
\input{chapters/2__PBS_Scheduler/sections/system_model/categorization_graph}
...
\input{chapters/2__PBS_Scheduler/sections/conclusion}