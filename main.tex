...
\usepackage{lastpage}
\usepackage{hhline}
\input{chapters/abbreviation-preamble}
...
\begin{document}
\include{chapters/1__Introduction/main}    %% Calls Introduction.tex
...
\include{chapters/2__PBS_Scheduler/main} %% Chapter 2
\include{chapters/3__Dynamic_Reputation/main} %% Chapter 3
% \include{chapters/4__Dissertation_Outline/main} %% Chapter 4
\include{chapters/5__Future_Work/main} %% Chapter 5

\include{chapters/6__Conclusion/main}     %% Honors theses are required to 
...
\input{chapters/7__Appendix/main} %% Calls toolong.tex which contains
